...
build_one_sdk() {
  ...
  # First real R/RB closure. This is an exact archive, like the Com_Init
  # subset: every owner must compile, and no unrelated census object may
  # silently enter the app link.
